...
add wave -noupdate /interface_1_tb/tb_PSTRB
add wave -noupdate /interface_1_tb/UUT/ALIGNMENT
add wave -noupdate /interface_1_tb/size_i
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1110035 ps} 0}
...
update
WaveRestoreZoom {1462697 ps} {1744069 ps}
