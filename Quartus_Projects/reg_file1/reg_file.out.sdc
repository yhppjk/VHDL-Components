## Generated SDC file "reg_file.out.sdc"
...
set_max_delay -from [get_ports {readAddress2[1] readAddress1[0] readAddress1[1] readAddress2[0] clk writeAddress[0] writeAddress[1] writeData[0] writeData[1] writeData[2] writeData[3] writeEna reset}] -to [get_ports {readData1[0] readData1[1] readData1[2] readData1[3] readData2[0] readData2[1] readData2[2] readData2[3]}] 15.000
...
set_min_delay -from [get_ports {readAddress2[1] readAddress1[0] readAddress1[1] readAddress2[0] clk writeAddress[0] writeAddress[1] writeData[0] writeData[1] writeData[2] writeData[3] writeEna reset}] -to [get_ports {readData1[0] readData1[1] readData1[2] readData1[3] readData2[0] readData2[1] readData2[2] readData2[3]}] 2.000
