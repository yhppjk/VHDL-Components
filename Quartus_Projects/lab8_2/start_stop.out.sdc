## Generated SDC file "start_stop.out.sdc"
...
set_max_delay -from [get_ports {rst ena clk pulse_in}] -to [get_ports {start_stop}] 15.000
...
set_min_delay -from [get_ports {rst ena clk pulse_in}] -to [get_ports {start_stop}] 2.000
